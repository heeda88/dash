...
layout_speech = html.Div(
    [
        dcc.Location(id='url', refresh=False),
        dbc.NavbarSimple(
            children=[
                dbc.NavItem(dbc.NavLink('Statistics', id='stats_link', href='/dash/speech', active=True)),
                dbc.NavItem(dbc.NavLink('Samples', id='samples_link', href='/dash/speech/samples')),
            ],
        ...
        dbc.Container(id='speech-page-content'),
    ]
)


@app.callback(
    [Output('speech-page-content', 'children'), Output('stats_link', 'active'), Output('samples_link', 'active')],
    [Input('url', 'pathname')],
)
def nav_click(url):
    if url == '/dash/speech/samples':
